...
import com.badlogic.gdx.graphics.g2d.Sprite;
	...
	public class enemy extends Sprite{
		...
		private enum State {stand,run,shoot,thrown,jump,die,fall,runShoot,jumpShoot,crouch,crouchShoot,crouchThrow};
		...
		public enemy(Play s,float x,float y){
...
//			shape.setAsBox(50/100f,50/100f);
		...
		public void automaticMouvement(float dt){
			//if(b2body | )
			movingRight=!movingRight;
			if(movingRight)
				moveRight(dt);
